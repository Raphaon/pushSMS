...
<body class="signup-page">
    ...
    <div class="signup-box">
        <div class="logo">
            ...
            <small>Send your sms around the world</small>
        </div>
        <div class="card">
            <div class="body">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="tel" class="form-control" name="phone" minlength="6" placeholder="Phone" required>
                        </div>
                    </div>
